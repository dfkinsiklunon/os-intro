...
![directory code](image/14.1.jpg)

2.main.c

![main.c](image/14.2.jpg)

  Calculate.c
  
 ![Calculate.c](image/14.3.jpg)
 
   Calculate.h
   
 ![Calculate.h](image/14.4.jpg)
 
3.Выполнение
 
 ![gcc code](image/14.5.jpg)
 
4.Исправлено
5.Makefile 
В содержании файла указаны флаги компиляции, тип компилятора и файлы, которые должен собрать сборщик.

![makefile](image/14.6.jpg)
...
![list с параметрами](image/14.8.jpg)

![Просмотр строк не основного файла](image/14.9.jpg)

![Точка остановы в calculate.c](image/14.10.jpg)

![Информация о точках остановы](image/14.11.jpg)

![Остановка на точке и backtrace](image/14.12.jpg)

![Значение Numeral cравнение с display](image/14.13.jpg)

![Удаление точек остановы](image/14.14.jpg)
