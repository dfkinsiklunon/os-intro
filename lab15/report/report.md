...
Изучилa приведённые в тексте программы server.c и client.c.

1. Работалa не 1 клиент, а несколько (например, два).

![server](image/15.1.jpg)

![server](image/15.2.jpg)

![client1](image/15.3.jpg)

![client2](image/15.4.jpg)

![common.h](image/15.5.jpg)

2. Клиенты передают текущее время с некоторой периодичностью (например, раз
в пять секунд). Используйте функцию sleep() для приостановки работы клиента.

![вывод](image/15.6.jpg)
